...
const handleLogin = async () => {
  if (!authKey.value) {
    message.error("Silakan masukkan kunci otorisasi");
    return;
  }
  loading.value = true;
  ...
  <div class="login-container">
    ...
    <div class="login-content">
      <div class="login-header">
        <h1 class="login-title">BarkahWorkspace</h1>
        <p class="login-subtitle">Platform Manajemen Penyeimbangan Beban Cerdas</p>
      </div>
      ...
      <n-card class="login-card modern-card" :bordered="false">
        <template #header>
          <div class="card-header">
            ...
            <p class="card-subtitle">Silakan masukkan kunci otorisasi Anda untuk melanjutkan</p>
          </div>
        </template>
        ...
        <n-space vertical size="large">
          <n-input
            ...
            type="password"
            size="large"
            placeholder="Silakan masukkan kunci otorisasi"
            class="modern-input"
